...
核心逻辑: **估值锚 = f(商业模式, 盈利状态, 生命周期)**。看哪个倍数在驱动市值：

| 盈利状态 | 主导倍数 | 推断 |
|---------|---------|------|
| 稳定盈利 (ROIC>8%) | PE 决定市值 | **利润锚** — 市场在定价盈利能力和增长 |
| 微利/亏损 (ROIC 0-8%) | PS 高企而 PE 失真 | **收入锚** — 市场在定价收入增长和 TAM |
| 深度亏损 (净利润<0) | PE 无意义, PS/PB 决定 | **收入锚或资产锚** |
| 重资产+低ROE | PB 决定市值 | **资产锚** — 市场在定价净资产质量 |
| 创新药/biotech | PE/PS 均无效 | **管线锚** — 市场在定价药品管线 |
| 多业务/转型 | 不同业务估值范式不同 | **SOTP** — 需要分部估值 |

**关键原则**:
- 盈利企业的估值锚是利润——即使事件叙事围绕"收入/TAM"，PS 只是一个过渡指标，PE 才是终点
