# Agent-2 家族（V8 / 2a / 2b / 旧）（4/4）

> 本文件是 [管线提示词全集](../管线提示词全集.md) 的分册。提示词正文均为源码原文，未摘要。

## 本册目录

- [ROUTING_V6_PROMPT](#routing_v6_prompt) — `估值重构引擎_V5/src/agent2b_routing.py`

---
<a id="routing_v6_prompt"></a>
## ROUTING_V6_PROMPT

- **源码**: `估值重构引擎_V5/src/agent2b_routing.py`  · 行 32-208
- **符号**: `ROUTING_V6_PROMPT`
- **管线阶段**: 管线 C · Agent-2b 路由判官
- **类型**: str · LLM
